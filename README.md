...
## Problem Statement
Mainstream food delivery platforms often lack reliable halal verification systems, charge high commission fees, and contribute to food waste through unsold meals.

## Proposed Solution
Pure Plate introduces a dedicated platform that includes:
- Verified halal certification badges for restaurants
- Eco-Saver feature offering discounted surplus meals
- Fair commission structure for restaurant partners

##  Research & Findings
- Surveyed 120 participants
- Conducted stakeholder interviews
- Strong demand identified for:
  - Trusted halal food verification
  - Food waste reduction solutions

## Design & Evaluation
- Prototype developed following HCI principles
- Usability testing conducted with 5 participants
- Achieved over 70% task success rate

##  Impact
Pure Plate combines trust, usability, and sustainability by:
- Helping Muslim users make confident food choices
...
This project is part of academic coursework in CS & IT / HCI 
